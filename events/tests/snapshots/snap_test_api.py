...
snapshots['test_event_group_query_wrong_project 1'] = {
    'data': {
        'eventGroup': None
    }
}
...
snapshots['test_events_and_event_groups_query_project_filtering First project in filter, permission to see both projects'] = {
    'data': {
        'eventsAndEventGroups': {
            'edges': [
                {
...
snapshots['test_events_and_event_groups_query_project_filtering No filter, no permission to see another project'] = {
    'data': {
        'eventsAndEventGroups': {
            'edges': [
                {
...
snapshots['test_events_and_event_groups_query_project_filtering No filter, permission to see both projects'] = {
    'data': {
        'eventsAndEventGroups': {
            'edges': [
                {
...
snapshots['test_update_valid_ticket_attended[False-False] 1'] = {
    'data': {
        'updateTicketAttended': {
            'ticket': {
                'attended': False,
...
snapshots['test_update_valid_ticket_attended[False-True] 1'] = {
    'data': {
        'updateTicketAttended': {
            'ticket': {
                'attended': True,
...
snapshots['test_update_valid_ticket_attended[True-False] 1'] = {
    'data': {
        'updateTicketAttended': {
            'ticket': {
                'attended': False,
...
snapshots['test_update_valid_ticket_attended[True-True] 1'] = {
    'data': {
        'updateTicketAttended': {
            'ticket': {
                'attended': True,
